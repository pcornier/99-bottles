...
## Language Malbolge ##
---
- Author: Hisashi Iizawa
- Date: 12/29/05
- Info: http
- Score:  (4.47 in 1898 votes)
- URL: n/a
- Original URL: http://www.99-bottles-of-beer.net/language-malbolge-995.html
---

```This program prints the string by real loop processing like programs in other languages.
To execute this, type as "malbolge 99bottles.mb".
